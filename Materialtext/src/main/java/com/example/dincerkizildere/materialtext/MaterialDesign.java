package com.example.dincerkizildere.materialtext;
...
public class MaterialDesign extends FrameLayout {
    ...
    public MaterialDesign(@NonNull Context context) {
        super(context);
        init();
    }

    public MaterialDesign(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        handleAttributes(context, attrs);
        init();
    }

    public MaterialDesign(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void reduce() {
        if (expanded){
            final int heightInitial =getContext().getResources().getDimensionPixelOffset(R.dimen.material_cardHeight_final);
